...
$address = "sarans.reflections@gmail.com";
...
if ( empty( $email ) ) {
	$error .= 'Votre adresse e-mail est obligatoire.';
} elseif ( !isEmail( $email ) ) {
	$error .= 'Vous avez saisi une adresse e-mail invalide.';
}
////////////////////////
...
if ( empty( $message ) ) {
	$error .= 'Vous devez saisir un message à envoyer.';
}
////////////////////////
...
if ( $session_verify != $posted_verify ) {
	$error .= 'Le code de vérification que vous avez entré est incorrect.';
}
////////////////////////
...
if ( mail( $address, $e_subject, $msg, $headers ) ) {
	...
	echo "<div class='alert alert-success'>Merci pour votre message et nous reviendrons vers vous très rapidement !</div>";
 $name = '';
 $phone = '';
$subject =''; 
$message ='';
